  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="bg-[#fbe2e3] -z-10 absolute bottom-[0rem] right-[-11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] lg:w-[90.75rem] 2xl:w-[150rem] dark:bg-[#2f273f]"></div>
