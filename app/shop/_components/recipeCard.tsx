    ...
    <div className="group">
      <div className="flex justify-center sm:justify-start">
        ...
        <div className="hidden sm:block p-8 md:p-10 lg:p-0 lg:mt-16 lg:ml-4 xl:ml-12">
          <p className="text-3xl font-black capitalize md:text-4xl lg:text-[3.3rem] lg:mt-8 xl:text-[4.5rem]">
            recipe generator
          </p>
          <p className="text-sm text-gray-500 py-2 lg:mt-6 lg:w-[500px] xl:mt-10 xl:w-[650px]">
