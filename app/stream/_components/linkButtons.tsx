...
function LinkButtons() {
  return (
    <div className="mt-8 w-full h-full flex flex-wrap justify-evenly mb-10 gap-6 px-3 max-w-[1200px] mx-auto">
      <a
        href="https://github.com/aqibshabir/stream-zone"
        target="_blank"
      ...
      <a className="flex justify-center items-center text-black/70 gap-2 dark:bg-transparent/40 dark:hover:bg-transparent/20 w-[300px] h-[60px] sm:px-12 sm:py-6 rounded-xl capitalize hover:text-black bg-white/90 hover:bg-white font-semibold cursor-pointer">
        live link
