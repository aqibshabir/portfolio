...
function LiveStreamCard() {
  return (
    <>
      <div className="flex justify-center mt-14 group-hover:scale-105 transition ml-8 sm:ml-4 sm:mt-24">
        <RiLiveLine className="w-[180px] h-[180px] sm:w-[220px] sm:h-[220px] md:w-[240px] md:h-[240px]" />
      ...
      <h2 className="mt-6 text-3xl font-black capitalize text-center sm:text-5xl sm:text-left sm:ml-6 md:ml-0 md:mt-12 md:text-5xl md:text-center">
        live streaming{" "}
        <span className="hidden sm:block md:hidden"> feature</span>
      </h2>
      <p className="mt-2 text-sm md:mt-2 md:p-2 text-center text-gray-500 sm:hidden md:block">
