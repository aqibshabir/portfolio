  ...
  return (
    <>
      <div className="group-hover:scale-105 flex justify-center mb-1">
        <SiObsstudio className="h-[70px] w-[70px] md:h-[80px] md:w-[80px]" />
      </div>
      <h2 className="text-2xl font-bold capitalize text-center mb-1 sm:text-3xl sm:mt-2 md:text-2xl md:mt-4">
        OBS studio connect
      </h2>
