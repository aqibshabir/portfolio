...
export const projectsData = [
  {
    ...
    tags: ['React', 'Redux', 'Javascript', 'SASS', 'Node', 'Express', 'MySQL', 'Puppeteer'],
  ...
  },
  {
    ...
    tags: ['React', 'TypeScript', 'Next.js', 'Tailwind', 'Prisma', 'Websockets'],
...
export const microAppData = [
  {
    ...
    description: 'An immersive 3D experience that allows user to build their own galaxies',
    tags: ['ThreeJS', 'Javascript'],
    icon: React.createElement(FaFolder),
    link: 'https://threejs-galaxy-dusky-tau.vercel.app/',
    github: 'https://github.com/aqibshabir/threejs-galaxy-generator',
  },
  {
    title: 'Hackathon App',
  ...
  {
    title: 'The Graveyard',
    description: 'An interactive 3D experience allowing the user to explore a spooky graveyard',
    tags: ['ThreeJS', 'Javascript'],
    icon: React.createElement(FaFolder),
    link: 'https://threejs-graveyard-six.vercel.app/',
    github: 'https://github.com/aqibshabir/threejs-graveyard',
  },
  {
    title: 'Simpsons App',
  ...
  {
    title: 'Weather App',
    description: "Using Open Weather Map's API to make an interactive weather app quiz.",
